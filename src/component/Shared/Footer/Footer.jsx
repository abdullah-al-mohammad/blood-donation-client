      ...
      <div className="container mx-auto footer footer-horizontal footer-center ">
        <aside>
          <div className="flip-container">
            <img
              className="transition-transform duration-500 flip-image"
              src={logo}
              alt=""
              sizes=""
            />
          ...
          <p className="font-bold">
            ...
            <br />
            Your blood can give someone another chance at life. Donate today and be the reason
            someone smiles tomorrow.
          </p>
          <p>
            Copyright © {new Date().getFullYear()} - Lifesaver Blood Donation | All rights reserved.
          </p>
