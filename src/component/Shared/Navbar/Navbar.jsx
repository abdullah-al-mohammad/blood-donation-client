...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      <li>
        <NavLink to="/dashboard/createDonationRequest">Donate Blood</NavLink>
      </li>
      <li>
  ...
  return (
    <div
      ...
      style={{
        background: scrolled ? 'linear-gradient(180deg, black, black, #740707)' : 'transparent',
      }}
    >
      <div className="container mx-auto">
        <div className="navbar-start">
          ...
          <Link
            to={'/'}
            className="btn bg-transparent border-none shadow-none text-xl dark:text-white"
          >
