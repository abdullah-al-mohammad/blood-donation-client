...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) => fetch(`https://blood-donation-server-nu-two.vercel.app/donations/${params.id}`)
      },
      {
        path: 'blog',
        element: <Blog></Blog>
      },
      {
        ...
        loader: ({ params }) => fetch(`https://blood-donation-server-nu-two.vercel.app/blogs/${params.id}`)
      },
      {
        path: 'register',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) => fetch(`https://blood-donation-server-nu-two.vercel.app/users/${params.id}`)
      },
      // donor page route
      {
        path: 'dashboardHome',
