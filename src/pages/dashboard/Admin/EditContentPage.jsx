...
const EditContentPage = ({ placeholder }) => {
  ...
  return (
    <section>
      ...
      <div className="adminBannerBG">
        <h1 className="capitalize text-2xl md:text-4xl text-center mb-5">all users</h1>
        ...
        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="card-body">
            ...
            <div className="form-control mt-6">
              <button className="btn bg-bold_red-0 hover:bg-white hover:border-bold_red-0 hover:text-bold_red-0">
                Update Blog
              </button>
            </div>
          </form>
