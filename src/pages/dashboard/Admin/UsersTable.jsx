...
const UsersTable = ({ user, loading, refetch }) => {
      ...
      <th>
        <details className="dropdown">
          ...
          <ul className="menu dropdown-content bg-base-100 rounded-box z-1 w-32 p-2 shadow-sm">
            <>
              <li>
                <button onClick={() => handleUpdateRole('admin')} type="button">
                  Admin
                </button>
              </li>
              <li>
                <button onClick={() => handleUpdateRole('volunteer')} type="button">
                  Volunteer
                </button>
              </li>
              <li>
                <button onClick={() => handleUpdateStatus('block')} type="button">
                  Block
                </button>
              </li>
              <li>
                <button onClick={() => handleUpdateStatus('unBlock')} type="button">
                  UnBlock
                </button>
              </li>
            </>
