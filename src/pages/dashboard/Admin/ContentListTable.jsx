...
const ContentListTable = ({ contentBlog, refetch }) => {
  ...
  return (
    <tr>
      ...
      <td>
        <div className="text-sm opacity-50">{plainTextContent}</div>
      </td>
      <td>{status}</td>
      <th>
        <details className="dropdown">
          ...
          <ul className="menu dropdown-content bg-base-100 rounded-box z-1 w-32 p-2 shadow-sm">
            <>
              <li>
                <button onClick={() => handleUpdateStatus('published')} type="button">
                  Publish
                </button>
              </li>
              <li>
                <button onClick={() => handleUpdateStatus('unpublished')} type="button">
                  Unpublish
                </button>
              </li>
              <li>
                <button onClick={() => handleDeleteBlog(_id)} type="button">
                  Delete
                </button>
              </li>
              <li>
