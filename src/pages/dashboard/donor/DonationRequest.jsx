  ...
  return (
    <div className="text-white">
      <div className="adminBannerBG">
        <h1 className="text-center p-5 uppercase text-2xl md:text-4xl" data-aos="flip-right">
          Emergency Blood Request
        </h1>
        <p className="text-center mb-5">
          Your information helps us find the right donor for your needs.
        </p>
          ...
          <div className="card bg-base-100 max-w-screen-2xl shrink md:shadow-2xl container mx-auto rounded-none">
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
              ...
              <div className="form-control mt-6">
                <button className="btn bg-bold_red-0 hover:bg-white hover:text-bold_red-0 hover:border-bold_red-0 transition duration-500 ease-in-out">
                  Create Donation
                </button>
              </div>
            </form>
