          ...
          <div className="card bg-[#c0c3c7] w-full max-w-sm shrink-0 shadow-2xl">
            <div className="card-body">
              <fieldset>
                ...
                <button onClick={handleSearch} className="btn bg-bold_red-0 transition ease-in-out duration-300 hover:bg-slate-200 hover:text-bold_red-0 mt-4 border-bold_red-0">Find Donors</button>
              </fieldset>
            </div>
          </div>
        </div>
