...
const Banner = () => {
  return (
    <div className='bannerBg min-h-screen py-28'>
     ...
     <p className='grid grid-cols-2'>Every drop of blood can make a difference. Donating blood is a simple yet powerful way to save lives. Join our mission to ensure that no one has to suffer due to a shortage of blood.</p>
     <ul className='mt-5'>
