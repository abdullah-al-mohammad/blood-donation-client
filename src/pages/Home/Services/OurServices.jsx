    ...
    <div className=' mb-40 group'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-x-10 place-content-center place-items-center gap-y-20 p-5'>
        <div className="overflow-hidden md:order-1 rounded">
          <img className='transition-all ease-in-out duration-500 hover:scale-[1.2]' src={service1} alt="" />
        </div>
        <div className="md:order-2">
          <h2 className='text-4xl md:text-7xl  text-gray-500'>01</h2>
          <h3 className='text-2xl md:text-4xl  mb-5 transition-all ease-in-out duration-500 group-hover:text-bold_red-0'>Free Health Checkup Before Donation</h3>
        ...
        <div className="overflow-hidden md:order-4 rounded">
          <img className='transition-all ease-in-out duration-500 hover:scale-[1.2]' src={service2} alt="" />
        </div>
        <div className="text-end md:order-3">
          <h2 className='text-4xl md:text-7xl  text-gray-500'>02</h2>
          <h3 className='text-2xl md:text-4xl  mb-5 transition-all ease-in-out duration-500 group-hover:text-bold_red-0'>Connected Blood Banks</h3>
        ...
        <div className="overflow-hidden hover:bg-black hover:bg-opacity-50 md:order-5 rounded">
          <img className='transition-all ease-in-out duration-500 transform hover:scale-[1.2]' src={service3} alt="" />
        </div>
        <div className="md:order-6">
          <h2 className='text-4xl md:text-7xl  text-gray-500'>03</h2>
          <h3 className='text-2xl md:text-4xl mb-5  transition-all ease-in-out duration-500 group-hover:text-bold_red-0'>Donor & Patient Support</h3>
