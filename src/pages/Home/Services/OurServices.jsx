    ...
    <div className='font-rubik_storm mb-40'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5 place-content-center place-items-center'>
        ...
        <div className="md:order-2 p-3">
          <h1 className='text-4xl md:text-7xl font-bold text-gray-500 mb-5'>01</h1>
          <h1 className='text-2xl md:text-4xl font-bold mb-5 transition-all ease-in-out duration-500 hover:text-[#ef3d32]'>Free Health Checkup Before Donation</h1>
        ...
        <div className="text-end md:order-3 p-3">
          <h1 className='text-4xl md:text-7xl font-bold text-gray-500 mb-5'>02</h1>
          <h1 className='text-2xl md:text-4xl font-bold mb-5 transition-all ease-in-out duration-500 hover:text-[#ef3d32]'>Connected Blood Banks</h1>
        ...
        <div className="md:order-6 p-3">
          <h1 className='text-4xl md:text-7xl font-bold text-gray-500 mb-5'>03</h1>
          <h1 className='text-2xl md:text-4xl mb-5 font-bold transition-all ease-in-out duration-500 hover:text-[#ef3d32]'>Donor & Patient Support</h1>
