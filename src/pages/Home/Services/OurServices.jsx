  ...
  return (
    <div className='font-rubik_storm mb-40'>
      <div className='text-center pb-16'>
        <p className='font-bold pb-6 text-bold_red-0'>What We Do</p>
        <h1 className='text-4xl md:text-6xl capitalize font-bold pb-6'>our best services</h1>
        <p className='md:text-2xl'>Discover the services that make us stand out and help you achieve your goals with ease</p>
      </div>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5 place-content-center place-items-center'>
        ...
        <div className="md:order-2 p-3">
          <h2 className='text-4xl md:text-7xl font-bold text-gray-500 mb-5'>01</h2>
          <h3 className='text-2xl md:text-4xl font-bold mb-5 transition-all ease-in-out duration-500 hover:text-[#ef3d32]'>Free Health Checkup Before Donation</h3>
        ...
        <div className="text-end md:order-3 p-3">
          <h2 className='text-4xl md:text-7xl font-bold text-gray-500 mb-5'>02</h2>
          <h3 className='text-2xl md:text-4xl font-bold mb-5 transition-all ease-in-out duration-500 hover:text-[#ef3d32]'>Connected Blood Banks</h3>
        ...
        <div className="md:order-6 p-3">
          <h2 className='text-4xl md:text-7xl font-bold text-gray-500 mb-5'>03</h2>
          <h3 className='text-2xl md:text-4xl mb-5 font-bold transition-all ease-in-out duration-500 hover:text-[#ef3d32]'>Donor & Patient Support</h3>
